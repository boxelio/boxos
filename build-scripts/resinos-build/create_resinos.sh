...
BOXOS_IMAGE="$DOCKER_REPO/$NAME-boxos"
...
BARYS_ARGUMENTS_VAR="-a HASSIO_MACHINE=$NAME -a BOXOS_IMAGE=$BOXOS_IMAGE -a RESINOS_HASSIO_VERSION=$RESINOS_HASSIO_VERSION"
...
DOCKER_IMAGE="$DOCKER_REPO/resinos-boxos"
...
cp "$BUILD_DEPLOY_DIR/resin.img.bz2" "$SCRIPTPATH/resinos-boxos-$RESINOS_HASSIO_VERSION-$NAME.img.bz2"
